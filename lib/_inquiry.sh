...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do FR-CWM que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador FR-CWM-FERNANDO R.P, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar FR-CWM\n"
  printf "   [1] Atualizar FR-CWM\n"
  printf "   [2] Deletar FR-CWM\n"
  printf "   [3] Bloquear FR-CWM\n"
  printf "   [4] Desbloquear FR-CWM\n"
  printf "   [5] Alter. dominio FR-CWM\n"
  printf "\n"
  read -p "> " option
